...
class TopFashionView extends StatefulWidget {
  const TopFashionView({Key? key}) : super(key: key);
                          ...
                          children: [
                            Padding(
                              ...
                              child: MasonryGridView.count(
                                ...
                                mainAxisSpacing: 23,
                                crossAxisSpacing: 23,
                                itemCount: fashionController.fashionTitle.length,
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Center(
                                                  child: Image(
                                                    image: AssetImage(fashionController
                                                        .fashionImageList[imageIndex]),
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          fashionController.fashionPrice[
                                                          imageIndex],
                                                          style: TextStyle(
                                                            fontWeight: FontWeight.w500,
                                                            fontSize: FontSize.body2,
                                                        ...
                                                        Obx(
                                                            ...
                                                            onTap: () {
                                                              fashionController
                                                                  .toggleFavorite(imageIndex);
                                                            },
                                                            child: Image(
                                                              image: AssetImage(
                                                                fashionController.isFavouriteList[imageIndex].value
