...
selectOrdersFilterBottomSheet(BuildContext context) {
                          ...
                          ListView(
                            ...
                            children: [
                              ...
                              ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: myOrdersController.filterOrderStatusList.length,
                                      ...
                                      Row(
                                        children: [
                                          Obx(
                                                () => GestureDetector(
                                              onTap: () {
                                                myOrdersController.toggleTopCheckbox(index);
                                              },
                                              child: Image(
                                                image: AssetImage(
                                                  myOrdersController.isCheckedTopList[index]
                                          ...
                                          Text(
                                            myOrdersController.filterOrderStatusList[index],
                                            style: TextStyle(
                              ...
                              ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: myOrdersController.filterOrderDateList.length,
                                itemBuilder: (context, index) {
                                  return Column(
                                    children: [
                                      Row(
                                        children: [
                                          Obx(
                                                () => GestureDetector(
                                              onTap: () {
                                                myOrdersController.toggleTopAllCheckbox(index);
                                              },
                                              child: Image(
                                                image: AssetImage(
                                                  myOrdersController.isCheckedTopAllList[index]
                                                      ? ImageConfig.checkboxFill
                                                      : ImageConfig.checkbox,
                                                ),
                                                width: SizeConfig.width18,
                                          ...
                                          Text(
                                            myOrdersController.filterOrderDateList[index],
                                            style: TextStyle(
                                              fontSize: FontSize.body1,
                                              fontWeight: FontWeight.w300,
                                              fontFamily: FontFamily.lexendLight,
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            GestureDetector(
                              onTap: () {
                                myOrdersController.resetTopFilters();
                                myOrdersController.resetTopAllFilters();
                              },
                              child: Container(
